...
function sumArray(sumArr) { //eslint-disable-line
  var firstElementtotal = sum(testArray[0],testArray[1]);
  var firstElementtotal2 = sum(firstElementtotal[0],testArray[2]);
  var secondndElementString = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + firstElementtotal2[0] + ' is their sum.'
  console.log(secondndElementString);

  return [firstElementtotal2[0], secondndElementString]
}
